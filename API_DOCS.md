...
The Neon Drive backend is a RESTful API built with Express.js and PostgreSQL. All responses follow a consistent format with `success`, `data`, and `error` fields.
